...
const BookAndEbookWriting = () => {
    ...
    const fetchServices = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_BASE_URL}/services?subcategory=Book and eBook Writing`
        );
  ...
  return (
    <section className="sub-category">
      <h2 className="sub-category-title">Book and eBook Writing Services</h2>
      <div className="sub-category-services-list">
        {services.length > 0 ? (
          ...
          <p>No Book and eBook Writing services found.</p>
        )}
      </div>
    </section>
  );
...
export default BookAndEbookWriting;
